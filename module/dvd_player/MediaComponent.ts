...
const ONE_PERCENT_VOLUME = dvd_player.VOLUME_MAX * 0.01;
const TEN_PERCENT_VOLUME = dvd_player.VOLUME_MAX * 0.1;
...
class MediaComponent {
    ...
    constructor( mediaService: dvd_player.MediaService ) {
    ...
    audioVolumeAdjust( percentageDelta: number ) {
    ...
    elapsedTimeAdjust( delta: number ) {
        ...
        if( 0 > delta ) {
            ...
            let titleLength = this.mediaService.mediaProperties.title_length;
    ...
    elapsedTimeOnChange( updatedElapsedTime: number  ) {
    ...
    playPauseOnClick() {
        ...
        if( this.mediaService.mediaProperties.has_media ) {
            ...
            let dvd_state = this.mediaService.mediaProperties.dvd_state;
